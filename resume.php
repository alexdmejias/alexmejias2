	...
	<section id="content" class="resume">
		...
		<div class="section">
			<div class="right">
				...
				<p class="description">Solely developed the entire website based on the inputs of the client. After various revisions the website was completed and the customer was extremely satisfied with the finished product.</p>
			</div>
		</div>
		<div class="section">
			<div class="right">
		...
		<div class="section">
			<div class="right">
				...
				<p class="description">Worked as part of a team who managed a retail store. Helped customers with various problems and assisted with on call maintenance. Responsible for creating past website and print advertisements.</p>
			</div>
		</div>
		<div class="section">
			<div class="left">
